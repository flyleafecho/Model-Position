...
public class ReadCSV {
	...
	public static Vector<ContextDocument> readSequence(String file, boolean isLable) {
		Vector<ContextDocument> docs = new Vector<ContextDocument>();
		String line = null;
		try {
	...
	public static Vector<ContextDocument> readSequence(String file) {
