...
public class linkLDA_milestone extends Model{
	/**
	 * @param args
	 */
...
*/
	...
	/*public static void main(String[] args) throws IOException{
		...
		int iterations = 5000;
		linkLDA_milestone linkLda = new linkLDA_milestone();
	...
	public static void main(String[] args) throws FileNotFoundException, IOException {
		...
		String output = "D:/WorkPaceEclipse_2/citation_LDA-master/dataset/VLDB_TS/content+citation/result_content_citation_iter5000_beta_gamma_0.01_#9.txt";
