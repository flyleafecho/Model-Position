...
public class LDA_content extends Model{
	/**
	 * @param args
	 */
	...
	public static void main(String[] args) throws FileNotFoundException, IOException {
		...
		String output = "D:/WorkPaceEclipse_2/citation_LDA-master/dataset/VLDB/result_content_iter1000.txt";
		
		int iterations = 1000;
		LDA_content linkLda = new LDA_content();
		...
		for(int i = 0; i < corpus.docAlphabet.size(); i++){
			...
			out.format("%d\t%.4f\t%s", assign,max,title);
			String line = out.toString();
